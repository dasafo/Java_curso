-- Crear la tabla 'clientes' en PostgreSQL
CREATE TABLE IF NOT EXISTS clientes (
  ...
  poblacion varchar(9),
  telefono varchar(16),
  responsable varchar(18),
  historial varchar(10)
);
...
('CT24', 'SÁEZ Y CÍA', 'INFANTA MERCEDES 23', 'SEVILLA', '(954) 86- 92- 34', 'MANUEL GUERRA', NULL),
...
('CT35', 'FERRETERÍA EL MARTILLO', 'CASTELLANOS 205', 'SALAMANCA', '(923) 54- 89- 65', 'JOAQUÍN FERNÁNDEZ', NULL),
