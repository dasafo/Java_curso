...
class Panel_Layout extends JPanel{
	...
	public Panel_Layout() {
		...
		// lamina.setLayout(new FlowLayout(FlowLayout.LEFT,85,100); //esto es lo mismo que las 2 lineas de arriba
...
class Panel_Layout2 extends JPanel{
	...
	public Panel_Layout2() {
		...
		add(new JButton("Violeta"),BorderLayout.NORTH);
